...
local setup = {
        ...
        win = {
                ...
                bo = {},
                wo = {
                        -- winblend = 10, -- 0-100 0-opaque 100-transparent
                },
        },
        layout = {
...
which_key.add({
        ...
        { "<leader>c", group = "Compile", nowait = true, remap = false },
                ...
                { "<leader>cm", group = "Make", nowait = true, remap = false },
                        { "<leader>cmB", "<cmd>Task start make buildRelease<cr>",
                                desc = "Make build release", nowait = true, remap = false },
                        { "<leader>cmb", "<cmd>Task start make build<cr>",
                                desc = "Make build", nowait = true, remap = false },
                        { "<leader>cmc", "<cmd>Task start make clean<cr>",
                                desc = "Make clean", nowait = true, remap = false },
                        { "<leader>cmr", "<cmd>Task start make run<cr>",
                                desc = "Make run", nowait = true, remap = false },
                        { "<leader>cmt", "<cmd>Task start make runTest<cr>",
                        ...
                        end, desc = "Run Advent of Code", nowait = true, remap = false },
                        { "<leader>cmA", function()
                                local input = vim.fn.input("Enter day to build: ")
                                vim.cmd("Task start make DAY=" .. input .. " build")
                        end, desc = "Build Advent of Code", nowait = true, remap = false },
