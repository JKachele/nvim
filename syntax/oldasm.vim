...
syn keyword nasmDotDirective	.org .word
...
syn keyword nasmStdInstruction adc and asl
syn keyword nasmStdInstruction bbr bbs bcc bcs beq bit bmi bne bpl bra brk bvc bvs
syn keyword nasmStdInstruction clc cld cli clv cmp cpx cpy
syn keyword nasmStdInstruction dec dex dey
syn keyword nasmStdInstruction eor
syn keyword nasmStdInstruction inc inx iny
syn keyword nasmStdInstruction jmp jsr
syn keyword nasmStdInstruction lda ldx ldy lsr
syn keyword nasmStdInstruction nop
syn keyword nasmStdInstruction ora
syn keyword nasmStdInstruction pha php phx phy pla plp plx ply
syn keyword nasmStdInstruction rmb rol ror rti rts
syn keyword nasmStdInstruction sbc sec sed sei smb sta stx sty stz
syn keyword nasmStdInstruction tax tay trb tsb tsx txa txs tya
syn keyword nasmStdInstruction wai
...
hi def link nasmDotDirective	Keyword
